export const DEFAULT_PROMPTS_BY_NAME = {
  ...
  generate_story_base: { label: 'Gerar história base', content: 'Gere história base curta em JSON com título, resumo, tags, atos, decisões e final editável.' },
  validate_content: { label: 'Validar conteúdo', content: 'Avalie se o texto contém conteúdo ilegal ou indevido. Responda JSON {"ok":true,"reason":""}.' },
  validate_external_url: { label: 'Validar URL externa', content: 'Avalie se a URL parece segura para imagem ou mídia. Responda JSON {"ok":true,"reason":""}.' },
  validate_username: { label: 'Validar nome de usuário', content: 'Avalie se o nome é apropriado para exibição pública. Responda JSON {"ok":true,"reason":""}.' },
